import { useQueries as c } from "./node_modules/.pnpm/@tanstack_react-query@5.80.7_react@19.1.0/node_modules/@tanstack/react-query/build/modern/useQueries.js";
...
const d = 3e3, y = async (r, u, i) => r.status(u, BigInt(i)), g = (r, u) => {
      ...
      return {
        ...
        queryFn: async () => {
          ...
          if (t.status === "confirmed")
            ...
            const o = t.status;
            console.warn(
              `⚠️ Unexpected relayer status "${o}" for ${n}:`,
              t
            ), e = {
              status: "unknown"
            };
        ...
        retry: (a, t) => a >= 30 ? (console.error(
          `❌ Giving up on transaction ${n} after 3 failed API attempts:`,
          t
        ), !1) : !0
      };
    })
  ...
  return l(() => {
    ...
    return (r || []).forEach((n, a) => {
      ...
      e ? e.isLoading && e.fetchStatus !== "idle" && !e.data ? s[t] = {
        status: "pending"
      } : e.isError ? s[t] = {
        status: "failed",
        reason: ((o = e.error) == null ? void 0 : o.message) || "An unknown error occurred"
      } : e.data ? s[t] = e.data : s[t] = {
        status: "unknown"
      } : s[t] = {
        status: "failed",
