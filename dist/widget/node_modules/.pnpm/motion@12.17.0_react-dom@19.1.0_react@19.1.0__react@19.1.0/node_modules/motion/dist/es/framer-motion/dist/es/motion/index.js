...
import { MotionConfigContext as g } from "../context/MotionConfigContext.js";
...
function Q({ preloadedFeatures: o, createVisualElement: t, useRender: e, useVisualState: n, Component: i }) {
  ...
  function l(a, p) {
    ...
    if (!u && P) {
      D(s, o);
      const M = G(s);
      m = M.MeasureLayout, r.visualElement = h(i, c, s, t, M.ProjectionNode);
    }
    return y(j.Provider, { value: r, children: [m && r.visualElement ? v(m, { visualElement: r.visualElement, ...s }) : null, e(i, a, b(c, r.visualElement, p), c, u, r.visualElement)] });
  }
